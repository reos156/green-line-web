        ...
        e.default = {
            ...
            ready: function(t, e) {
                var i = window.document,
                    o = new(s())(n);
                r = e, o.observe(i.documentElement, {
                    childList: !0,
                    subtree: !0,
                    removedNodes: !0
                })
        ...
        if (m.fn.fancybox) console.info("fancyBox already initialized");
            ...
            var t, e, i, o, s = {
                ...
                v = function(t, e, i) {
                    ...
                    o.opts = f({
                        index: i
                    }, m.fancybox.defaults), m.isPlainObject(e) && (o.opts = f(o.opts, e)), m.fancybox.isMobile && (o.opts = f(o.opts, o.opts.mobile)), o.id = o.opts.id || ++a, o.currIndex = parseInt(o.opts.index, 10) || 0, o.prevIndex = null, o.prevPos = null, o.currPos = 0, o.firstRun = !0, o.group = [], o.slides = {}, o.addContent(t), o.group.length && o.init()
                };
            m.extend(v.prototype, {
                init: function() {
                    ...
                    s.closeExisting && m.fancybox.close(!0), m("body").addClass("fancybox-active"), !m.fancybox.getInstance() && !1 !== s.hideScrollbar && !m.fancybox.isMobile && c.body.scrollHeight > l.innerHeight && (m("head").append('<style id="fancybox-style-noscroll" type="text/css">.compensate-for-scrollbar{margin-right:' + (l.innerWidth - c.documentElement.clientWidth) + "px;}</style>"), m("body").addClass("compensate-for-scrollbar")), i = "", m.each(s.buttons, function(t, e) {
                        i += s.btnTpl[e] || ""
                    }), e = m(o.translate(o, s.baseTpl.replace("{{buttons}}", i).replace("{{arrows}}", s.btnTpl.arrowLeft + s.btnTpl.arrowRight))).attr("id", "fancybox-container-" + o.id).addClass(s.baseClass).data("FancyBox", o).appendTo(s.parentEl), o.$refs = {
                        container: e
    ...
    n.extend(o.prototype, {
        ...
        focus: function(t) {
            var e, i, o = this,
                s = o.$list,
                n = o.$grid;
            o.instance.current && (i = (e = s.children().removeClass(a).filter('[data-index="' + o.instance.current.index + '"]').addClass(a)).position(), "y" === o.opts.axis && (i.top < 0 || i.top > s.height() - e.outerHeight()) ? s.stop().animate({
                ...
                switch (t.pureOptions.threshold = t.$item.getAttribute("data-threshold") || "", u) {
                    ...
                    case "onScroll":
                        var a = t.getWindowData(),
                            ...
                            h = c,
                            p = d;
                        null !== t.options.thresholdY && c > t.options.thresholdY && (h = 0), null !== t.options.thresholdX && d > t.options.thresholdX && (p = 0), t.css(t.$item, {
    ...
    var o = {
        ...
        slick: function() {
            ...
            0 < !t.length || t.each(function(t, e) {
                l(e).on("init", function(t, e) {}).slick({
                    autoplay: !0,
                    autoplaySpeed: 3e3,
                    adaptiveHeight: !0,
                    dots: !0,
        ...
        gallerySorting: function() {
            ...
            if (!(0 < !o.length)) {
                ...
                o.find("a").on("click", function(t) {
                    var e = l(this),
                        i = e.data("cat");
                    return o.find(".selected").removeClass("selected"), e.addClass("selected"), "*" !== i && (i = "." + i), s.isotope({
                        filter: i
                    }), !1
                })
            }
        ...
        scrollTo: function() {
            l('a[href*="#"]').not('[href="#"]').not('[href="#0"]').on("touchend click", function(t) {
                ...
                if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
                    var e = l(this.hash);
                    return (e = e.length ? e : l("[name=" + this.hash.slice(1) + "]")).length && l("html,body").stop().animate({
        ...
        scrollTop: function() {
            ...
            if (!(0 < !e.length)) {
                ...
                o.on("click", function(t) {
                    return t.preventDefault(), l("body,html").stop().animate({
                        scrollTop: 0
                    }, 1500), !1
